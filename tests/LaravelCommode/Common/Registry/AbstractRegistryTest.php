...
namespace LaravelCommode\Common\Registry;
...
class AbstractRegistryTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $abstractRegistryMock = $this->getMockBuilder(
            'LaravelCommode\Common\Registry\AbstractRegistry'
    ...
    public function testValid()
    {
        ...
        $this->assertSame($mock->key() !== null, $mock->valid());
